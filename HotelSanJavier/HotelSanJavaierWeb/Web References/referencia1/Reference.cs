...
namespace HotelSanJavaierWeb.referencia1 {
    ...
    public partial class HotelSanJavier : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/getClientsByReceptionist", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public System.Data.DataTable getClientsByReceptionist(int idReceptionist) {
            object[] results = this.Invoke("getClientsByReceptionist", new object[] {
                        idReceptionist});
            return ((System.Data.DataTable)(results[0]));
        }
        
        /// <remarks/>
        public void getClientsByReceptionistAsync(int idReceptionist) {
            this.getClientsByReceptionistAsync(idReceptionist, null);
        }
        
        /// <remarks/>
        public void getClientsByReceptionistAsync(int idReceptionist, object userState) {
            if ((this.getClientsByReceptionistOperationCompleted == null)) {
                this.getClientsByReceptionistOperationCompleted = new System.Threading.SendOrPostCallback(this.OngetClientsByReceptionistOperationCompleted);
            }
            this.InvokeAsync("getClientsByReceptionist", new object[] {
                        idReceptionist}, this.getClientsByReceptionistOperationCompleted, userState);
        }
        
        private void OngetClientsByReceptionistOperationCompleted(object arg) {
            if ((this.getClientsByReceptionistCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.getClientsByReceptionistCompleted(this, new getClientsByReceptionistCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// <remarks/>
        public void addClientAsync(string dni, string password, int telephone, string name, string surname, string email, int id_receptionist) {
            this.addClientAsync(dni, password, telephone, name, surname, email, id_receptionist, null);
        }
        
        /// <remarks/>
        public void addClientAsync(string dni, string password, int telephone, string name, string surname, string email, int id_receptionist, object userState) {
            ...
            this.InvokeAsync("addClient", new object[] {
                        ...
                        surname,
                        email,
                        id_receptionist}, this.addClientOperationCompleted, userState);
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void getClientsByReceptionistCompletedEventHandler(object sender, getClientsByReceptionistCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class getClientsByReceptionistCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal getClientsByReceptionistCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
